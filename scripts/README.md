...
## Loop Engineering Installer

This repo can be published as an installable Loop Engineering Pack. After the
files are on GitHub, users can install it into any Harness repo:
...
Verify the installed loop pack:
